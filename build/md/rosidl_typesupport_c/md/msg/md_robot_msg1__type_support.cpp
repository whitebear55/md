...
static const _MdRobotMsg1_type_support_symbol_names_t _MdRobotMsg1_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, md, msg, MdRobotMsg1)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, md, msg, MdRobotMsg1)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, md, msg, MdRobotMsg1)() {
  return &::md::msg::rosidl_typesupport_c::MdRobotMsg1_message_type_support_handle;
}
