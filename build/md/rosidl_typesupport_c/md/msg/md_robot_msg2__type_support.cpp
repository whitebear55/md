...
static const _MdRobotMsg2_type_support_symbol_names_t _MdRobotMsg2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, md, msg, MdRobotMsg2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, md, msg, MdRobotMsg2)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, md, msg, MdRobotMsg2)() {
  return &::md::msg::rosidl_typesupport_c::MdRobotMsg2_message_type_support_handle;
}
