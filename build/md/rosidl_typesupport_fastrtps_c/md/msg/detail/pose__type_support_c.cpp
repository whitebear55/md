...
#include "md/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = md__msg__Pose;
...
size_t get_serialized_size_md__msg__Pose(
  const void * untyped_ros_message,
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_md__msg__Pose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_md
size_t max_serialized_size_md__msg__Pose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_md__msg__Pose(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, md, msg, Pose)() {
