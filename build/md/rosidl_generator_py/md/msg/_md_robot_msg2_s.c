...
bool md__msg__md_robot_msg2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("md.msg._md_robot_msg2.MdRobotMsg2", full_classname_dest, 33) == 0);
  }
  md__msg__MdRobotMsg2 * ros_message = _ros_message;
  {  // interval_time
...
PyObject * md__msg__md_robot_msg2__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("md.msg._md_robot_msg2");
