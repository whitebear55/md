...
static const _MdRobotMsg2_type_support_symbol_names_t _MdRobotMsg2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, md, msg, MdRobotMsg2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, md, msg, MdRobotMsg2)),
  }
};
...
{
  return &::md::msg::rosidl_typesupport_cpp::MdRobotMsg2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, md, msg, MdRobotMsg2)() {
  return get_message_type_support_handle<md::msg::MdRobotMsg2>();
}
