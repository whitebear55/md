...
static const _MdRobotMsg1_type_support_symbol_names_t _MdRobotMsg1_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, md, msg, MdRobotMsg1)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, md, msg, MdRobotMsg1)),
  }
};
...
{
  return &::md::msg::rosidl_typesupport_cpp::MdRobotMsg1_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, md, msg, MdRobotMsg1)() {
  return get_message_type_support_handle<md::msg::MdRobotMsg1>();
}
